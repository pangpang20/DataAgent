...
-- 智能体示例数据
INSERT IGNORE INTO `agent` (`id`, `name`, `description`, `avatar`, `status`, `api_key`, `api_key_enabled`, `prompt`, `category`, `creator_id`, `tags`, `create_time`, `update_time`, `human_review_enabled`) VALUES
...
-- 预设角色
INSERT IGNORE INTO sys_role (role_name, role_key, description, sort_order, status) VALUES
...
-- Agent操作按钮
(1001, 101, '编辑Agent', 'button', NULL, NULL, NULL, 'agent:update', 1),
...
-- 权限标识
INSERT IGNORE INTO sys_permission (permission_name, permission_key, description, resource_type) VALUES
('查看Agent列表', 'agent:list', '查看Agent列表', 'agent'),
('创建Agent', 'agent:create', '创建新Agent', 'agent'),
('更新Agent', 'agent:update', '更新Agent配置', 'agent'),
