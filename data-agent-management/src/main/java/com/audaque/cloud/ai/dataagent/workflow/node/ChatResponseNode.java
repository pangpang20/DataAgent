...
/**
 * Node for handling chat or irrelevant intent responses. Returns a friendly message when
 * the user's input is not a data analysis request.
 */
@Slf4j
@Component
public class ChatResponseNode implements NodeAction {

	private static final String DEFAULT_CHAT_RESPONSE = "您好！我是 AI 问数助手，专门帮助您进行数据查询和分析。" + "请尝试提出与数据相关的问题，例如：\n"
			+ "- 查询某个时间段的销售数据\n" + "- 统计某个指标的趋势变化\n" + "- 分析数据之间的关联关系\n\n" + "如果您有具体的数据分析需求，请告诉我！";
