...
public class OssResource extends AbstractResource {
	...
	public InputStream getInputStream() throws IOException {
		try {
			...
			log.error("Failed to get OSS object due to client error: bucket={}, key={}, errorMessage={}", bucketName,
	...
	public boolean exists() {
		try {
			...
			log.warn("Failed to check OSS object existence: bucket={}, key={}, error={}", bucketName, objectKey,
					e.getMessage());
			return false;
		}
	}
