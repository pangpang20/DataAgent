...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ApiResponse<Void>> handleBindException(BindException e) {
		...
		return ResponseEntity.badRequest().body(ApiResponse.error("参数绑定失败: " + errorMessage));
	}
	...
	public ResponseEntity<ApiResponse<Void>> handleConnectionTestException(ConnectionTestException e) {
		...
		return ResponseEntity.badRequest().body(ApiResponse.error("连接测试失败: " + e.getMessage()));
	}
	...
	public ResponseEntity<ApiResponse<Void>> handleRuntimeException(RuntimeException e) {
		...
		return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(ApiResponse.error("系统内部错误，请联系管理员"));
	}
