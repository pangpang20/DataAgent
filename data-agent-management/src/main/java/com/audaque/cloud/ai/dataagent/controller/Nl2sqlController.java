...
/**
 * NL2SQL Stream Controller for Widget integration. Provides API Key based authentication
 * for external widget embedding.
 */
@Slf4j
@RestController
@AllArgsConstructor
...
public class Nl2sqlController {
	...
	/**
	 * Stream endpoint for widget chat. Authenticates via API Key and streams NL2SQL
	 * results.
